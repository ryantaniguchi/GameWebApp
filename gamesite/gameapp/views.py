...
def rated_index(request):
    ...
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Playtime", "Thematic", "Strategy", "War", "Family", "CGS", "Abstract", "Party", "Child"]].sort_values(by="AvgRating").iloc[::-1]
    # Removes any games that have less than 1000 user reviews
    rated_df = filtered_added_df[filtered_added_df["NumRatings"] > 1000]
...
def thematic_index(request):
    ...
    df=pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Thematic"]].sort_values(by="AvgRating").iloc[::-1]
...
def strategic_index(request):
    ...
    df=pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Strategy"]].sort_values(by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def war_index(request):
    ...
    df=pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "War"]].sort_values(by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def family_index(request):
    ...
    df=pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Family"]].sort_values(by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def cgs_index(request):
    ...
    df=pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "CGS"]].sort_values(by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def abstract_index(request):
    ...
    df = pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Abstract"]].sort_values(
        by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def party_index(request):
    ...
    df = pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Party"]].sort_values(
        by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
def children_index(request):
    ...
    df = pd.DataFrame(item)
    # Filters out any columns that are not required and sorts them by average rating
    filtered_added_df = df[["BGGId", "Name", "AvgRating", "NumRatings", "Child"]].sort_values(
        by="AvgRating").iloc[::-1]
    # Removes any games that are of the wrong category
...
# Allows rendering of the add webpage
